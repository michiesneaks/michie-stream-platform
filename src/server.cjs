...
app.use('/api',                          nftPlatformRoutes);   // /api/claim-platform-nft, /api/check-platform-nft

app.use('/api/access',                   accessRoutes);        // GET  /api/access/:wallet
...
app.use('/api',                          royaltyRoutes);       // /api/tip, /api/nft-sale-fee, /api/set-royalty-splits, /api/royalty-splits

app.use('/api/upload',                   uploadRoutes);
app.use('/api/catalog',                  catalogRoutes);

app.use('/api/playlists',                playlistRoutes);
app.post('/api/create-playlist',         (req, res, next) => { req.url = '/'; playlistRoutes(req, res, next); });
...
app.use('/api',                          utilityRoutes);       // /api/fees, /api/convert-currency, /api/nfts
